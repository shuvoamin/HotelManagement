...
public class Booking extends Unique {
	...
	public Booking(Customer customer, Room room, String dateBooked,String dateArrived,int numberOfNights) {
		super();
		this.customer = customer;
		this.room = room;
		this.numberOfNights = numberOfNights;
		try {
			this.dateBooked = dateFormatter.parse(dateBooked);
			this.dateArrived = dateFormatter.parse(dateArrived);
	...
	public int days() {
		...
		long tNow = dateCheckedOut != null ? dateCheckedOut.getTime()
				: new Date().getTime();
	...
	public double price() {
		...
		double price = days() * room.getType().getPrice() + additionalCosts();
		if(customer.isGold())

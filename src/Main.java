...
public class Main {
	...
	int b1 = bookingSystem.book(c1, h1, 1, "01/01/2009","21/02/2009",1);
	int b2 = bookingSystem.book(c2, h2, 2, "02/01/2009", "22/02/2009",2);
	int b3 = bookingSystem.book(c3, h2, 3, "03/02/2009", "20/02/2009",10);
	
	// Shows checking for existing booking...
	bookingSystem.book(c3, h2, 3, "20/02/2009", "20/02/2009",8);
	...
	bookingSystem.arrive(b2);
	// Question 1....
	bookingSystem.arrive(b3);
	...
	bookingSystem.useSpa(b3, 200.0);
	bookingSystem.buyDrink(b3, 10.0);
	bookingSystem.buyMeal(b3, 25.0);
	...
	// Question 1...
	bookingSystem.checkout(b3, 4000.0, "01/03/2009");
	...
	b1 = bookingSystem.book(c1, h1, 1, "01/01/2009","21/02/2009",1);
	bookingSystem.arrive(b1);
	bookingSystem.checkout(b1, 1000.0, "22/02/2009");
